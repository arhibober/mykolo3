...
get_header(); ?>
	...
	<div id="primary" class="content-area">
		<div id="content" class="site-content" role="main">77
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<?php 
						echo "tt<table><tr><td>". __("Username: ")."</td><td>". __("Email: ")."</td><td>". __("Name: ")."</td><td>". __("Surname: ")."</td><td>". __("Registration Code: ")."</td></tr>";
						global $wpdb, $user_ID;			
